EN_WHITELIST = '0123456789abcdefghijklmnopqrstuvwxyzабвгдеёжзийклмнопрстуфхцчшщъыьэюя ' # space is included in whitelist
EN_BLACKLIST = '!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~\''
...
def process_data():
    questions, answers = gather_dataset2()
...
def split_dataset(x, y, ratio = [0.7, 0.15, 0.15] ):
    ...
    validX, validY = x[-lens[-1]:data_len], y[-lens[-1]:data_len]

    print('Splitting done:','len', data_len, ', train_len', len(trainX))
